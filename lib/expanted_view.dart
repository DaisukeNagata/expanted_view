...
class ExpantedView extends StatefulWidget {
  ...
  @override
  State<ExpantedView> createState() => _ExpantedViewState();
}

class _ExpantedViewState extends State<ExpantedView> with SingleTickerProviderStateMixin {
  ...
  Widget _buildChildren(BuildContext context, Widget? child) {
    ...
    return Container(
      decoration: BoxDecoration(
          ...
          // border: Border(
        //    top: BorderSide(color:  (widget.index % 2 == 0) ? Colors.yellow : Colors.white),
        //   bottom: BorderSide(color:  (widget.index % 2 != 0) ? Colors.yellow : Colors.white),
        // ),
      ),
      child: Column(
          ...
          Container(
            child: SizedBox(
              ...
              child: ListTileTheme.merge(
                ...
                child: ListTile(
                  onLongPress: widget.gestureTapCallback,
                  onTap: handleTap,
